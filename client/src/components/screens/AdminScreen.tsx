...
export default function AdminScreen({
  ...
  const nonAdminUsers = useMemo(() => {
    return [...users].filter((user) => !user.isAdmin).sort((a, b) => a.name.localeCompare(b.name));
  }, [users]);
        ...
        <div className="max-w-md mx-auto space-y-3">
          ...
          <div className="space-y-2">
            <button
              ...
              className="w-full bg-white/5 backdrop-blur-xl border border-white/10 text-white font-semibold py-4 px-5 rounded-2xl flex items-center space-x-4 active:scale-95 transition-all"
            >
