    ...
    switch (currentScreen) {
      case 'auth':
        return (
          <AuthScreen
            ...
            onShowAdmin={props.handleShowAdmin}
      ...
      case 'admin':
        return (
          <AdminScreen
            users={props.users}
            onShowAddUserModal={props.handleShowAddUserModal}
            onShowCreateEventModal={props.handleShowCreateEventModal}
            onShowEventList={props.handleShowAdminEvents}
            onShowEditUserModal={props.handleShowEditUserModal}
            onDeleteUser={props.handleDeleteUser}
            onGoBack={() => setCurrentScreen('auth')}
            onGoHome={() => setCurrentScreen('auth')}
            onChangeAdminPin={props.handleShowChangeAdminPin}
          />
        );
      ...
      case 'events':
        return (
          <EventListScreen
            ...
            wines={props.wines}
            votes={props.votes ?? []}
            onShowEventDetails={props.handleShowEventDetails}
            onShowEventResults={props.handleShowEventResults}
            onShowAdmin={props.handleShowAdmin}
            onRegisterWine={props.handleShowWineRegistration}
            onParticipateEvent={props.handleParticipateEvent}
            onVoteForWine={props.handleVoteForWine}
            onEditWine={props.handleEditWine}
            onShowHistoricEvents={props.handleShowHistoricEvents}
          />
        );
      ...
      case 'adminEvents':
        return (
          <AdminEventManagementScreen
            ...
            onActivateVoting={props.handleActivateVoting}
            onDeactivateVoting={props.handleDeactivateVoting}
            onCompleteEvent={props.handleCompleteEvent}
            onViewReport={props.handleViewReport}
      ...
      case 'voting':
        return props.currentEvent && props.currentUser ? (
          <SimpleVotingScreen
      ...
      case 'eventDetails':
        return props.currentEvent ? (
          <EventDetailsScreen
            ...
            users={props.users}
            currentUser={props.currentUser}
            onShowWineRegistrationModal={() => props.setShowWineRegistrationModal(true)}
            onVoteForWine={props.handleVoteForWine}
            onCompleteEvent={props.handleCompleteEvent}
