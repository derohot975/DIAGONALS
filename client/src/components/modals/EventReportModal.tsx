import { Crown as Trophy, Wine } from '@/components/icons';
...
export default function EventReportModal({ isOpen, onClose, reportData }: EventReportModalProps) {
  ...
  const title = (
    <div className="flex items-center space-x-3">
      ...
      <div>
        <div className="event-name-standard text-xl font-bold whitespace-nowrap overflow-hidden text-ellipsis max-w-sm">
